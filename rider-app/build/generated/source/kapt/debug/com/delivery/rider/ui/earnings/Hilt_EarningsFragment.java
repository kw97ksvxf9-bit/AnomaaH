...
public abstract class Hilt_EarningsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_EarningsFragment() {
    super();
  }

  Hilt_EarningsFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((EarningsFragment_GeneratedInjector) this.generatedComponent()).injectEarningsFragment(UnsafeCasts.<EarningsFragment>unsafeCast(this));
    }
  }
