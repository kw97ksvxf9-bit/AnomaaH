...
public final class ItemOrderBinding implements ViewBinding {
  ...
  private ItemOrderBinding(@NonNull MaterialCardView rootView, @NonNull TextView tvDropoff,
      @NonNull TextView tvFee, @NonNull TextView tvOrderId, @NonNull TextView tvPickup,
  ...
  public static ItemOrderBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemOrderBinding((MaterialCardView) rootView, tvDropoff, tvFee, tvOrderId,
          tvPickup, tvStatus, tvTime);
    }
